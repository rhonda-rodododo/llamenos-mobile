/**
 * Nostr relay connection manager for Llamenos mobile.
 *
 * Port of web app's relay.ts with these changes:
 * - crypto.randomUUID() replaced with bytesToHex random (not in Hermes)
 * - WebSocket API is compatible between web and React Native
 */
...
/** Generate a random subscription ID (replaces crypto.randomUUID) */
