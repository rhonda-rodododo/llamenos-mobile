...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      ...
      build:
        'xcodebuild -workspace ios/Hotline.xcworkspace -scheme Hotline -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build ONLY_ACTIVE_ARCH=YES EXCLUDED_ARCHS=x86_64',
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath:
      ...
      build:
        'xcodebuild -workspace ios/Hotline.xcworkspace -scheme Hotline -configuration Release -sdk iphonesimulator -derivedDataPath ios/build ONLY_ACTIVE_ARCH=YES EXCLUDED_ARCHS=x86_64',
    },
    'android.debug': {
      type: 'android.apk',
